...
public class UserService implements CrudService {
    ...
    @Override
    public DomainCreationResponse create(Object dto) {

        UserCreateRequestDto u = (UserCreateRequestDto) dto;

        ValidationResult[] validationResults = domainValidator.doValidate(dto);
