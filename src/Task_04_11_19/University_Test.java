...
class Student extends Person {
    ...
    @Override
    public String toString() {
        return "Student " + super.toString() + "      " + "Course:" + getCourse() + "      " + "Faculty:" + getFaculty();
    }
}
...
class Teacher extends Person {
    ...
    @Override
    public String toString() {
        return "Teacher " + super.toString() + "      " + "Facolty:" + getFaculty() + ";";
    }
}
...
public class University_Test {
    ...
    public static void main(String[] args) {
        Student a1 = new Student("ANI", "MINASYAN", 2, "xxx");
        Student a2 = new Student("SIMON", "KARAPETYAN", 3, "yyy");

        Student[] students = new Student[]{a1, a2};

        Teacher t1 = new Teacher("AVAG", "VARDANYAN", "yyy");
        Teacher t2 = new Teacher("KARAPET", "KARAPETYAN", "xxx");

        Teacher[] teachers = new Teacher[]{t1, t2};

        Group group2 = new Group("220/3", students);
        Group group1 = new Group("320/1", students);
